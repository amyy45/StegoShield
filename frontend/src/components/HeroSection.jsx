    ...
    <div className="relative">
      ...
      <div className="relative">
        <header>
          ...
          <nav
            className={`pb-5 md:text-sm ${isOpen ? "absolute top-0 inset-x-0 bg-white shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-0 md:mt-0 md:relative md:bg-transparent" : ""}`}
          >
            <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
              <Brand />
              <div
                className={`flex-1 items-center mt-8 md:mt-0 md:flex ${isOpen ? "block" : "hidden"}`}
              >
